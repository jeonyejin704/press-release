...
const CONTACT = "문의사항이 있을 경우 홍보팀(054-279-2416)으로 연락 부탁드립니다.";
...
export const REQUEST_GUIDE: Record<RequestType, string> = {
  RESEARCH:
    ...
    "솔루션에 입력하지 마시고, 아래 '보도자료 초안 양식'을 내려받아 작성하신 뒤 파일로 업로드해 주세요. " +
    "홍보팀이 업로드된 초안을 검토·보완하여 최종본을 완성합니다. " +
    "연구진 사진과 대표 이미지도 함께 첨부해 주시면 좋습니다. " +
    CONTACT,
  AWARD:
...
export const DETAIL_FORM: Record<RequestType, FieldDef[]> = {
  RESEARCH: [
    ...
    { name: "doi", label: "논문 DOI", hint: "예: 10.1000/example" },
